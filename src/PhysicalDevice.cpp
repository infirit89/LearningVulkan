...
LogicalDevice *PhysicalDevice::CreateLogicalDevice() {
  ...
  transferQueueCreateInfo.queueFamilyIndex =
      m_QueueFamilyIndices.TransferFamily.value_or(0);
  transferQueueCreateInfo.queueCount = 1;
  transferQueueCreateInfo.pQueuePriorities = &queuePriority;

  size_t queueCreateInfosSize =
      m_QueueFamilyIndices.TransferFamily.has_value() ? 2 : 1;
  ...
  deviceCreateInfo.ppEnabledExtensionNames =
      VulkanUtils::DeviceExtensions.data();
